...
class Arabic
{
    ...
    /** @var array<string> */
    private $arNormalizeAlef = array('أ','إ','ٱ','آ');
    ...
    private function arNumbersInit()
    {
        ...
        foreach ($json['individual']['male'] as $num) {
            if ($num['value'] < 11) {
                $str = strtr((string)$num['text'], array('أ' => 'ا','ٱ'  => 'ا' , 'إ' => 'ا', 'آ' => 'ا'));
    ...
    public function isFemale($str)
    {
        ...
        $str = strtr($str, array('أ' => 'ا','ٱ'  => 'ا' , 'إ' => 'ا', 'آ' => 'ا'));
    ...
    private function arGlyphsPreConvert($str)
    {
        ...
        for ($i = $max - 1; $i >= 0; $i--) {
            ...
            if (
                ...
                && (mb_strpos('آأإٱا', $nextChar) !== false)
            ) {
    ...
    public function arNormalizeText($text, $numeral = null)
    {
        ...
        if ($this->normaliseAlef) {
            $text = strtr($text, array('أ' => 'ا', 'ٱ'  => 'ا' , 'إ' => 'ا', 'آ' => 'ا', 'ى' => 'ا'));
        }
